...
('En Progreso', 'El incidente está siendo analizado o verificado por el equipo técnico.'),
('En Espera', 'Incidente pausado a la espera de confirmación o recursos.'),
('Cerrado', 'Incidente resuelto y validado por el sistema o por mantenimiento.'),
('Cancelado', 'Incidente anulado por detección errónea o duplicada.'),
('Reabierto', 'Incidente previamente cerrado que volvió a ocurrir.'),
('Escalado', 'Incidente elevado a un nivel superior por criticidad.');
...
('Diente ausente detectado.', 'Confirmar físicamente en terreno.', 1, 6, 7, 6),
...
('Falsa alarma descartada.', 'Sistema ajustado tras calibración.', 5, 10, 5, 10),
('Error de transmisión.', 'Pérdida de paquete en red local.', 1, 1, 6, 11),
('Diente fisurado detectado.', 'Alerta escalada a supervisor.', 2, 2, 7, 12),
('Verificación manual en curso.', 'Esperando confirmación de mantenimiento.', 3, 3, 1, 13),
...
('Error recurrente.', 'Se reabre incidente previo.', 3, 8, 6, 18),
...
('Alerta crítica.', 'Escalado a supervisor general.', 3, 8, 7, 28),
('Evento duplicado.', 'Se cancela registro redundante.', 4, 9, 5, 29),
...
('Detección falsa.', 'Revisión de modelo AI en curso.', 2, 2, 5, 32),
('Cámara térmica sin respuesta.', 'Se solicita inspección.', 3, 3, 1, 33),
('Pérdida temporal de red.', 'Servicio restablecido.', 4, 4, 4, 34),
('Registro duplicado.', 'Cancelado manualmente.', 5, 5, 5, 35),
('Anomalía menor.', 'Supervisada en dashboard.', 1, 6, 3, 36),
('Aumento de temperatura.', 'Se activa protocolo de seguridad.', 2, 7, 7, 37),
...
('Se reabre caso por repetición.', 'Revisión adicional requerida.', 1, 6, 6, 46),
('Revisión pendiente.', 'Esperando asignación.', 2, 7, 1, 47),
('Alerta normalizada.', 'Sin riesgo operativo.', 3, 8, 4, 48),
('Diente desprendido.', 'Alerta prioritaria.', 4, 9, 7, 49),
('Falsa alarma descartada.', 'Confirmación manual.', 5, 10, 5, 50),
...
('Advertencia por ruido.', 'Pendiente validación.', 5, 5, 3, 55),
('Vibración estabilizada.', 'Sin anomalías.', 1, 6, 4, 56),
('Desgaste detectado nuevamente.', 'Revisión recurrente.', 2, 7, 6, 57),
...
('Alerta duplicada.', 'Descartada automáticamente.', 1, 6, 5, 66),
...
('Diente desgastado.', 'Planificar reemplazo.', 4, 4, 7, 74),
